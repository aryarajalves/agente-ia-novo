...
def migrate():
    ...
    migrations = [
        ("agent_config", "security_verification_agent_enabled", "BOOLEAN DEFAULT FALSE"),
        ("agent_config", "security_verification_agent_rules", "TEXT"),
        ("agent_config", "security_verification_agent_prompt", "TEXT"),
    ]
