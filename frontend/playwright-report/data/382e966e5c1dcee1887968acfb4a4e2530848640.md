...
- Name: webhook_ui.spec.js >> Webhook Management UI Updates >> should show Maximizar button for long pipeline steps
- Location: src/test/e2e/webhook_ui.spec.js:46:3
