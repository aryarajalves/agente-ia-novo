...
async function run() {
    ...
    try {
        ...
        console.log("8. Clicando no primeiro card de Lead para expandir...");
        try {
            await page.locator('.lead-card-premium').first().click({ force: true, timeout: 5000 });
            await page.waitForTimeout(2000);
        } catch (clickError) {
            console.warn("Aviso: Falha ao clicar no card de lead:", clickError.message);
        }

        console.log("9. Salvando screenshot do modal de leads...");
        const screenshotPath = 'C:/Users/aryar/.gemini/antigravity/brain/ad7ddbd0-494c-49f0-a826-fc00c2b5093e/valida_leads_depois.png';
