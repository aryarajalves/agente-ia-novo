...
export const useConfigSave = () => {
    const {
        ...
        safetySettings, reasoningEffort, dateAwareness, simulatedTime,
        systemPrompt, contextWindow, knowledgeBaseIds, selectedTools,
        ...
        initialIgnoreMessage, qualificationQuestions, qualificationLabels, securityBlacklist, securityForbidden,
